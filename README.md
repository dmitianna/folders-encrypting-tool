...
Вывод:<br>
Файл пропускается или выводится ошибка. Остальные файлы обрабатываются.<br>

---

### Тест-кейс 24. Скрытая директория
Предусловие:<br>
...
Вывод:<br>
Операция не выполняется. Выводится сообщение об ограничении.<br>

---

### Тест-кейс 25. Скрытые файлы
Предусловие:<br>
...
Вывод:<br>
Скрытые файлы пропускаются, остальные обрабатываются.<br>
...
Вывод:<br>
Сообщение об ошибке: `Error: specified path is not a folder.`<br>
Пароль не запрашивается. Операция не выполняется.<br>
