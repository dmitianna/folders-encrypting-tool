...
Вывод:<br>
Программа не переходит к выполнению операции. Выводится сообщение о том, что ввод не должен быть пустым. Запрашивается повторный ввод команды.<br>
...
Вывод:<br>
Выводится сообщение о неизвестной команде. Операция не выполняется. Запрашивается повторный ввод команды.<br>
...
Вывод:<br>
Выводится сообщение о том, что путь не существует. Пароль не запрашивается. Операция не выполняется.<br>
...
Вывод:<br>
Выводится сообщение о том, что указанный путь не является директорией. Пароль не запрашивается. Операция не выполняется.<br>
...
Входные данные:<br>
Ввести `encrypt`.<br>
Нажать Enter или ввести строку из пробелов на этапе ввода пути.<br>

Вывод:<br>
Выводится сообщение о том, что ввод не должен быть пустым. Запрашивается повторный ввод.<br>
...
Нажать Enter или ввести строку из пробелов на этапе ввода пароля.<br>

Вывод:<br>
Выводится сообщение об ошибке, что пароль не должен быть пустым. Операция не выполняется.<br>
...
Вывод:<br>
Выводится сообщение о превышении максимальной длины пароля. Операция не выполняется.<br>
...
Ввести `encrypt`.<br>
Ввести путь к директории.<br>
Ввести пароль длиной 64 символа.<br>
...
Предусловие:<br>
Директория ранее зашифрована.<br>

Входные данные:<br>
Ввести `decrypt`.<br>
Ввести путь к директории.<br>
Ввести корректный пароль.<br>
...
Предусловие:<br>
Директория зашифрована.<br>

Входные данные:<br>
Ввести `decrypt`.<br>
Ввести путь к директории.<br>
Ввести неверный пароль.<br>
...
Вывод:<br>
Файлы успешно расшифровываются. Структура сохраняется.<br>
...
Ввести `decrypt`.<br>
Ввести путь к директории.<br>
Ввести один пароль.<br>

Вывод:<br>
Часть файлов расшифровывается, часть остаётся зашифрованной. Ошибки отображаются.<br>
